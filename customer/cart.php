    ...
    <div class="page-content">
    	<div class="container"> 
    		<div class="serach-area"> 
    			...
    			<!-- TITLE -->
    			<p class="title my-2 text-left h3">Carts</p>
    			<!-- TITLE -->
    		...
    		<div class="view-title">
    			<div class="container">
    				<ul>
    					<li>
    						<span>Subtotal</span>
    						<span>₦ <?php echo $result = isset($_SESSION['total_price']) ? number_format($_SESSION['total_price'], 00) : "0" ?></span>
    					</li>
    					<hr>
    					<li>
    						<h5>Total</h5>
    						<h5>₦ <?php echo $result = isset($_SESSION['total_price']) ? number_format($_SESSION['total_price'], 00) : "0" ?></h5>
    					</li>
    				</ul>

    				<?php if(isset($_SESSION["cart_item"]) AND !empty($_SESSION["cart_item"])): ?>
    					<a href="checkout" class="btn btn-primary btn-rounded btn-block flex-1 ms-2">CHECKOUT</a>
    				<?php endif; ?>
