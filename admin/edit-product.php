                      ...
                      <form method="POST" enctype="multipart/form-data">
                        <div class="row">
                          ...
                          <div class="form-group col-md-2">
                            ...
                            <input type="text" class="form-control" name="old_price" value="<?= $fetchProductData->old_price; ?>" placeholder="10.5">
                          </div>
                          <div class="form-group col-md-2">
                            <label>New Price</label>
                            <input type="text" class="form-control" name="new_price" value="<?= $fetchProductData->new_price; ?>" placeholder="13.5">
                          </div>
                          <div class="form-group col-md-2">
                          ...
                          <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control summernote-simple" name="description"><?= $fetchProductData->description; ?></textarea>
                          </div>
                          <div class="col-12">
