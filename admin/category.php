                    ...
                    <div class="table-responsive">
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody> 
                          <?php
                            $i = 1;
                            foreach ($admin->selectAllAsc('tblcategory','name') as $fetchCategory):
                          ?>                                
                          <tr>
                            <td>
                              <?= $i++; ?>
                            ...
                            <td>
                              <a href="edit-category?id=<?= $fetchCategory->cat_id; ?>" class="btn btn-warning mb-2">Edit</a>
                              
                              <form method="POST">
                                <input type="hidden" class="form-control" name="cat_id" value="<?= $fetchCategory->cat_id; ?>" readonly>
                                <input type="submit" class="btn btn-danger" name="btnDeleteCategory" onclick="return confirm('Remove this category?')" value="Delete">
                              </form>
                            </td>
                          </tr>
                          <?php
