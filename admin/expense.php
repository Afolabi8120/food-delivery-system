                      ...
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody> 
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="edit-expense?id=<?= $fetchExpense->expense_id; ?>" class="btn btn-warning mb-2">Edit</a>
                              <form method="POST">
                                <input type="hidden" class="form-control" name="expense_id" value="<?= $fetchExpense->expense_id; ?>" readonly>
                                <input type="submit" class="btn btn-danger" name="btnDeleteExpense" onclick="return confirm('Remove this record?')" value="Delete">
                              </form>
                            </td>
                          </tr>
                          <?php
