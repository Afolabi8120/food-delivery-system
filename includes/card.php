    ...
    <div class="card card-statistic-1">
      ...
      <div class="card-wrap">
        <div class="card-header">
          <h4>Total Customer(s)</h4>
        </div>
        <div class="card-body">
          <?= $admin->count('tblcustomers'); ?>
        </div>
      </div>
    </div>
  </div>
...
<div class="row">
  <div class="col-lg-6 col-md-6 col-sm-12 col-12">
    <div class="card">
      <div class="card-header">
        <h4>Stock Alert <br><span class="small text-danger">These are items running out of stock, that are less than or equal to reorder level</span></h4>
      </div>
      <div class="card-body">
          ...
          <tbody> 
            ...
            foreach ($product->fetchAllLowStock() as $fetchProduct):
              ...
              <tr>
                ...
                <td>
                  <?= number_format($fetchProduct->new_price, 00); ?>    
                </td>
                ...
                <td>
                  <a href="edit-stock?id=<?= $fetchProduct->product_id; ?>" class="btn btn-info"><i class="fas fa-pen"></i></a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
