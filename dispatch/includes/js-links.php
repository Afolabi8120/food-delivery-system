...
<script src="../customer/assets/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
<script src="../customer/assets/js/settings.js"></script>
<script src="../customer/assets/js/custom.js"></script>
<script src="../customer/assets/vendor/wnumb/wNumb.js"></script>
<script src="../customer/assets/js/noui-slider.init.js"></script>
<script src="../customer/assets/vendor/nouislider/nouislider.min.js"></script>
...
<script src="../customer/assets/css/notifications/js/lobibox.min.js"></script>
<script src="../customer/assets/css/notifications/js/notification-custom-script.js"></script>
<script src="../customer/assets/css/notifications/js/notifications.min.js"></script>
<script src="../customer/assets/vendor/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.js"></script>
