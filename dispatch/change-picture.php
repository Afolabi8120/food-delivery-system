...
<body class="bg-white">
    ...
    <div class="page-content">
    	<div class="container">
            <p class="title my-2 h3">Change Picture</p>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data">
                                <div class="mb-3 input-group input-radius">
                                    ...
                                    <input type="file" class="form-control" name="user-img" required >
                                </div>
                                <input type="submit" class="btn btn-primary btn-block flex-1 ms-2" name="btnChangePicture" value="SUBMIT">
                            </form>
                        </div>
                    </div>
                </div>
