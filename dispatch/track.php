<?php 
  ...
  $getCustomerID = $admin->fetchSingle('tblcart','invoiceno',$invoiceno);
  $getCustomerDetails = $admin->fetchSingle('tblcustomers','id',$getCustomerID->user_id);
            ...
            <div class="detail-box">
                ...
                <div class="d-flex align-items-center">
                    <div class="media media-60">
                        <?php if($getCustomerDetails->picture == ""): ?>
                            <img src="../customer/assets/images/customer_image/user_default.jpg" alt="">    
                        <?php elseif($getCustomerDetails->picture != ""): ?>
                             <img src="../customer/assets/images/customer_image/<?= $getCustomerDetails->picture; ?>" alt="">
                        <?php endif; ?>
                    </div>
                    <div class="ms-3">
                        <h5><a class="text-white fw-bold" href="javascript:;"><?= ucwords($getCustomerDetails->fullname); ?></a>
                        </h5>
                    </div>
                </div>
                <div class="social">
                    <a href="tel:<?= $getCustomerDetails->phone; ?>">
